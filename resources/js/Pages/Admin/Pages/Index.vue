...
const remove = (value: any) => {
    form.delete(route('admin.pages.destroy', value), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    <AdminLayout>
        <Head><title>{{ trans('admin.pages') }}</title></Head>
        ...
        <div class="bg-primary my-10">
            <div class="overflow-x-auto text-white">
                <table class="table-auto w-full">
                    ...
                    <tr v-for="page in pages.data" class="rounded-lg">
                        <td class="p-4">
                            {{ page.name[locale] }}
                        </td>

                        <td class="p-4 text-right space-x-2">
                            <Link v-if="page.name" :href="route('admin.pages.edit', page)" method="get" as="button">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </Link>

                            <Link href="#" @click="remove(page)" as="button">
