...
const form = useForm({
    name_uk: props.page.name['uk'],
    name_en: props.page.name['en'],
    content_uk: props.page.content['uk'],
    content_en: props.page.content['en'],
    description_uk: props.page.description['uk'],
    description_en: props.page.description['en'],
    slug: props.page.slug
})

const submit = () => {
    form.put(route('admin.pages.update', props.page), {
        preserveScroll: true,
        onSuccess: () => {
        ...
        <div class="bg-primary text-white my-10 p-5">
            <form @submit.prevent="submit">
                ...
                <div class="mt-4">
                    ...
                    <small>Українською</small>
                    <textarea id="content_uk" v-model="form.content_uk" placeholder="Description"
                ...
                <div class="mt-4">
                    ...
                    <small>English</small>
                    <textarea id="content_en" v-model="form.content_en" placeholder="Description"
                        class="w-full text-white p-2 rounded bg-secondary"></textarea>
                ...
                <div class="mt-4">
                    ...
                    <TextInput id="slug" v-model="form.slug" :placeholder="trans('admin.slug.description')" />
